...
{
  if(analysis)
    analysis->registerBase2RefinedMapping(supersetPart, shared_from_this());
}
...
PartEdgePtr IntersectionPart::outEdgeToAny()
{
  ...
  dbg << "getSupersetPart()->outEdgeToAny()="<<getSupersetPart()->outEdgeToAny()->str()<<endl;*/
