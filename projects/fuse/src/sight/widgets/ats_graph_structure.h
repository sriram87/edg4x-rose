...
class atsGraph : public sight::structure::graph {
  ...
  atsGraph(std::set<PartPtr>& startParts, boost::shared_ptr<std::map<PartPtr, std::list<anchor> > > partAnchors, bool dirAligned,                        sight::properties* props=NULL);
  ...
  atsGraph(std::set<PartPtr>& startParts, boost::shared_ptr<std::map<PartPtr, std::list<anchor> > > partAnchors, bool dirAligned, const attrOp& onoffOp, sight::properties* props=NULL);
  ~atsGraph();
  ...
  static sight::properties* setProperties(std::set<PartPtr>& startParts, boost::shared_ptr<std::map<PartPtr, std::list<anchor> > >& partAnchors, bool dirAligned, const attrOp* onoffOp, sight::properties* props);
